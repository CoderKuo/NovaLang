...
final class HirEvaluator implements HirVisitor<NovaValue, Void> {
    ...
    private com.novalang.runtime.types.Modifier extractHirVisibility(Set<Modifier> modifiers) {
        if (modifiers.contains(Modifier.PRIVATE)) return com.novalang.runtime.types.Modifier.PRIVATE;
        if (modifiers.contains(Modifier.PROTECTED)) return com.novalang.runtime.types.Modifier.PROTECTED;
        if (modifiers.contains(Modifier.INTERNAL)) return com.novalang.runtime.types.Modifier.INTERNAL;
        return com.novalang.runtime.types.Modifier.PUBLIC;
    }
    // ============ 声明的 visit 方法 (9) ============

...
public final class StdlibTestCompiled {
    ...
    private static Object unwrap(Object o) {
        if (o instanceof nova.runtime.NovaValue) return ((nova.runtime.NovaValue) o).toJavaValue();
        return o;
    }
    ...
    private static boolean isTruthy(Object value) {
        ...
        if (value instanceof nova.runtime.NovaValue) return ((nova.runtime.NovaValue) value).isTruthy();
        return true;
    }
}
